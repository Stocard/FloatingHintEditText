...
public class FloatingHintAutoCompleteTextView extends AutoCompleteTextView {
	...
	public FloatingHintAutoCompleteTextView(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.autoCompleteTextViewStyle);
	}

	public FloatingHintAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
